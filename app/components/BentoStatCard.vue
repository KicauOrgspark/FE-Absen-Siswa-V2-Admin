...
<template>
  <div class="bg-surface-white border border-surface-container-highest rounded-lg p-6 flex flex-col justify-between shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
    <!-- Accent Bar -->
    <div
    ...
    <div class="flex justify-between items-center mb-6 z-10">
      <span class="font-label text-[11px] text-secondary font-bold uppercase tracking-widest">{{ title }}</span>
      <span
